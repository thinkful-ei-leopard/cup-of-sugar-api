...
VALUES
  ...
  (4, 2, 'daniel', 'daniel', 'offer', 'Grocery store runs on Tuesdays', 00999, 3, 'To anyone not feeling safe during these times going to the grocery store, I will be making runs on Tuesdays and will happily pick up some items for you.');
